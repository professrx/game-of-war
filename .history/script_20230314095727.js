...
class GameOfWar {
    ...
    war() {
        ...
        if (this.p1Card.val > this.p2Card.val) {
            console.log("Player 1 wins round!")
            this.p1.push(...this.pile.splice(0, 3), p2Card, p1Card)
        } else if (this.p2Card.val > this.p1Card.val) {
            console.log("Player 2 wins round!")
            this.p2.push(...this.pile.splice(0, 3), p2Card, p1Card)
        } else {
